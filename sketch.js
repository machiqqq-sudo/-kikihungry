const questions = [
    ...
    },
    {
        ...
        options: [
            ...
            { text: "大喊「我就愛吃大麥克」，然後快樂吃胖胖", type: "麥當勞" } // 👈 新增這行
        ]
    },
    {
        ...
        options: [
            ...
            { text: "雙拱金：配上番茄紅，經典不敗", type: "麥當勞" } // 👈 新增這行
        ]
    },
    {
...
function showResult() {
    ...
    const descriptions = {
        ...
        "麥當勞": "速食界的王者，金黃酥脆的薯條與多汁的漢堡，是深夜裡最溫暖的罪惡感。代表作如大麥克。" // 👈 新增這行
    };
    ...
    const imageUrls = {
        ...
        "浙菜": "images/浙菜.png",
        "魯菜": "images/魯菜.png",
        "麥當勞": "images/mcdonalds.jpg" // 👈 新增這行 (記得要準備這張圖！)
    };
    ...
    const musicUrls = {
        ...
        "浙菜": "music/zhe.mp3",
        "魯菜": "music/lu.mp3",
        "麥當勞": "music/mcdonalds.mp3" // 👈 新增這行 (記得要準備這首音樂！)
    };
